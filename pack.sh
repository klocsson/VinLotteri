#!/bin/bash
APP_NAME="VinLotteri.app"
PUBLISH_OUTPUT_DIRECTORY="/Users/michal/Projects/VinLotteri/VinLotteri/bin/Release/net5.0/osx-x64/publish/."
...
INFO_PLIST="VinLotteri/Assets/Info.plist"
ICON_FILE="wine.icns"
